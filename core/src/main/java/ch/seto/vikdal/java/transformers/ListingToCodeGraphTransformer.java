...
public class ListingToCodeGraphTransformer {

	/**
	 * Transforms a list of instructions into a code graph.
	 ...
	 */
	public Function transform(SortedMap<Integer, Instruction> code, ClassMethodDescriptor method) {
		// generate a code graph from the instruction list
		DirectedGraph<GraphNode, GraphEdge> graph = new DirectedMultigraph<>(GraphEdge.FACTORY);
